...
class InputExample(object):#giong bert, gan giong albert_vi (ko co guid)
...
class InputFeatures(object):#khac bert, ko co self.unique_id
...
#gan giong def convert_examples_to_features(examples, seq_length, tokenizer): (bert)
