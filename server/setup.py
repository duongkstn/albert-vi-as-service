...
setup(
    ...
    entry_points={
        'console_scripts': ['albert-vi-serving-start=bert_serving.server.cli:main',
                            'albert-vi-serving-benchmark=bert_serving.server.cli:benchmark',
                            'albert-vi-serving-terminate=bert_serving.server.cli:terminate'],
    },
